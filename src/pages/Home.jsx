        ...
        <div className="flex justify-between items-center w-full">
          ...
          <div className="flex-1 flex justify-center">
            <ul className="flex space-x-6">
              <li>
                <a
                  href="https://github.com/TISEPSE/Projet-BTS-Alan-Maxime-Tisba"
        ...
        <div className="max-w-screen-xl mx-auto text-gray-600 gap-x-12 items-center justify-between overflow-hidden md:flex md:px-8">
          <div className="flex-none space-y-5 px-4 sm:max-w-lg md:px-0 lg:max-w-xl">
            ...
            <p className="text-lg leading-relaxed">
              Simplifiez la gestion de vos réservations avec notre solution tout-en-un. 
              <span className="block mt-2">
                Que vous soyez professionnel ou particulier, Book By Click vous offre 
                une expérience de réservation fluide, intuitive et sécurisée.
              </span>
            </p>
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-700">Réservations en temps réel</span>
              </div>
              <div className="flex items-center space-x-2">
                <svg className="w-5 h-5 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-700">Sécurité et fiabilité garanties</span>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-gray-400 mb-4 max-w-md">
                Book By Click révolutionne la gestion des réservations avec une solution 
                simple, efficace et sécurisée pour tous vos besoins de planning.
              </p>
