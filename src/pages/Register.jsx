    ...
    <main className="w-full h-screen flex items-center justify-center bg-gray-50">
      <div className="w-full space-y-6 text-gray-600 sm:max-w-md">
        ...
        <div className="bg-white shadow p-4 py-6 sm:p-6 sm:rounded-lg text-left">
          <form onSubmit={e => e.preventDefault()} className="space-y-5" action="http://localhost:5000/register_form" method="POST">
            <div className="flex flex-col items-start">
              ...
              <input
                ...
                name="name"
                required
                className="w-full mt-2 px-3 py-2 text-black-500 bg-transparent outline-none border border-gray-300 focus:border-indigo-600 shadow-sm rounded-lg"
              />
            </div>
